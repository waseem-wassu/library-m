...
<!--_________________sidenav_______________-->
	...
	<a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
				...
				<div style="color: white; margin-left: 60px; font-size: 20px;">
								...
								{ 	echo "<img class='rounded-circle profile_img' height=120 width=120 src='images/".$_SESSION['pic']."'>";
										echo "</br></br>";
...
<div id="main">
	...
	<div class= "container container1 ">
		<h3  class="text-center edittop">Information of Borrowed Books</h3><br>
		<?php
		$c=0;
			...
			if(isset($_SESSION['username']))
			{
				...
				echo "<table class='table table-bordered container table-responsive-sm' >";
				//Table header
		...
		echo "</table>";
			...
			{
				?>
					<h3 class="text-center edittop.php">Login to see information of Borrowed Books</h3>
				<?php
			}
		?>
	</div>
