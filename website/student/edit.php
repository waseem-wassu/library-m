...
<div class="container edittop">
	...
	<?php 
		...
		if(isset($_POST['submit']))
		{
			...
			$sql1= "UPDATE student SET pic='$pic', first='$first', last='$last', username='$username', password='$password', email='$email', contact='$contact' WHERE username='".$_SESSION['username']."';";
