...
<div class="container log-box">
					...
					<form action="" method="post">
						...
						<div class="form-group">
							<label>Rollno</label>
							<input type="text" name="roll" placeholder="Enter your rollno" class="form-control color ">    
						</div>
...
<?php
	...
	$q = " SELECT * FROM student WHERE username = '$username' && password = '$pwd'";
	...
	$sql = "INSERT INTO student (first,last,username,password,roll,email,contact,pic) VALUES ('$first','$last','$username','$pwd','$roll','$email','$cont','pic.jpg');";
